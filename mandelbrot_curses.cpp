// code found on github, fixed some small bugs and made it work for my macbook terminal size
#include <iostream>
...
int main() {
	...
	int width = 140; //number of characters on one line
	int heigth = 42; //number of chars vertically
